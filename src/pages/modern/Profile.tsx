...
import BackButton from "../../components/modern/back-button.tsx";
import Avatar from "../../components/modern/avatar.tsx";
import Input from "../../components/modern/input.tsx";
...
const ProfileHeader: FC<{ heading: ReactNode }> = ({heading}) => {
    return (
        <div className={'flex items-center my-4 gap-2'}>
            <BackButton/>
            <span className={'text-xl text-primary font-semibold'}>{heading} Modern</span>
        </div>
    )
}
...
const LoadingScreen: FC = () => {
    return (
        <PageWrapper>
            ...
            <div className={'glass flex flex-col gap-10 p-6 flex-1'}>
        ...
        <PageWrapper className={'h-auto'}>
            ...
            <div className={'glass flex flex-col gap-10 p-6 flex-1'}>
                <div className={'flex sm:flex-row flex-col items-center gap-4 text-3xl font-bold'}>
                    <Avatar name={profile.name} className={'w-20 h-20 text-xl rounded-full'}/>
            ...
            <div className={'glass flex flex-col gap-4 mt-10 p-6 '}>
